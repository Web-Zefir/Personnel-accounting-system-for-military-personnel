...
// 1. Динамическая генерация 20 колонок
const columns = [
  { key: 'id', name: '№' },
...
const departments = ['управление', '1-й отдел', '2-й отдел', 'ИТ-служба', 'логистика', 'безопасность'];
const positions = ['командир полка', 'заместитель командира', 'начальник штаба', 'главный специалист', 'инженер', 'оператор', 'аналитик'];
const ranks = ['полковник', 'подполковник', 'майор', 'капитан', 'ст. лейтенант', 'гражданский'];
